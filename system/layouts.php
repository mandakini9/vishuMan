            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <a href="<?= SYS_URL ?>manager_dashboard.php" class="nav-link">Home</a>
                        <?php } elseif($_SESSION['DESIGNATION'] == 'Cashier') {?>
                        <a href="<?= SYS_URL ?>cashier_dashboard.php" class="nav-link">Home</a>
                        <?php } elseif($_SESSION['DESIGNATION'] == 'Reception'){ ?>
                        <a href="<?= SYS_URL ?>reception_dashboard.php" class="nav-link">Home</a>
                        <?php } elseif($_SESSION['DESIGNATION'] == 'Card Checker'){ ?>
                        <a href="<?= SYS_URL ?>card_dashboard.php" class="nav-link">Home</a>
                        <?php } ?>
                    </li>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            ...
                            <p class="text-white"><?= $_SESSION['DESIGNATION'] ?></p>
                        </div>
                    </div>
