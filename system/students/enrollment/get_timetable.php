...
<style>
    .ttgardient {
    background-image: linear-gradient(to right,#011b34, #004080); 
    border-radius: 5px;
}
...
//            echo "Created date is " . date("h:i", $stime);
            ...
            <h6 class="card-text">
                <div class="ttgardient">
                    <span class="badge">
                        <span class="badge me-2 ttday "><?= $row['wday'] ?></span>
                    ...
                    <span class="badge">
                        <a href="enrollpayment.php?gradeId=<?= $gradeId; ?>&subjectId=<?= $subjectId ?>&mediumId=<?= $mediumId ?>&studentId=<?= $studentId ?>">
