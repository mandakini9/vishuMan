...
//                                $message['error'] = "Upload";
                                if (empty($message)) {
                                    ...
                                    $db = dbConn();
                                    echo $sql = "INSERT INTO `classpayments`( `StudentId`, `ClassName`, `TotalFee`, `PaidDate` ,`BankName`, `BranchName`, `UploadSlip`) "
                                            . "VALUES ('$stid','$ClassName','$totalfee','Bank',CURRENT_DATE,'$bankname','$branchname','$file_name')";
                                    $db->query($sql);
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $sql2 = "SELECT Amount FROM addmissions WHERE Year = YEAR(CURDATE())";
                                            $result2 = $db->query($sql2);
