...
$db = dbConn();
echo $sql = "SELECT DISTINCT t.FirstName,t.LastName ,t.TeacherId as id FROM teachers_grades g INNER JOIN teachers t ON t.TeacherId=g.TeacherId LEFT JOIN users u ON u.UserId=t.UserId WHERE u.Status=1 AND "
