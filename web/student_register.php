                        ...
                        <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch shadow p-3 mb-5 bg-body rounded" data-aos="fade-up" data-aos-delay="200">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if (empty($message)) {
                                    ...
                                    $sql = "INSERT INTO students (`FirstName`, `LastName`, `Email`, `Gender`, `GradeId`, "
                                            . "`SchoolName`, `AddressLine1`, `AddressLine2`, `MobileNo`, `SRegNo`, `UserId`,`status`, `PNIC`) "
                                            . "VALUES ('$first_name','$last_name','$email','$gender','$grade','$schoolname',"
                                            . "'$addressline1','$addressline2','$mobile_no','$reg_number','$user_id', '2','$NIC')";
                                    $db->query($sql);
