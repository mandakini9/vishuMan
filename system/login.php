                ...
                <div class="col-xl-10 col-lg-12 col-md-9">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if (empty($message)) {
                            ...
                            $result = $db->query($sql);
                            echo $sql_2 = "SELECT * FROM users u INNER JOIN employee e ON e.UserId=u.UserId LEFT JOIN designations d ON d.Id=e.DesignationId"
                            . " WHERE u.UserName='$username'";
                            $result_2 = $db->query($sql_2);
                            $row_2 = $result_2->fetch_assoc();
                            $_SESSION['DESIGNATION'] = $row_2['Designation'];
                            ...
                            if ($result->num_rows == 1) {
                                ...
                                if (password_verify($password, $row['Password'])) {
                                    ...
                                    if ($row_2['Designation'] == 'Manager') {
                                        header("Location:manager_dashboard.php");
                                    } if ($row_2['Designation'] == 'Cashier') {
                                        header("Location:cashier_dashboard.php");
                                    } if ($row_2['Designation'] == 'Reception') {
                                        header("Location:reception_dashboard.php");
                                    } if ($row_2['Designation'] == 'Card Checker') {
                                        header("Location:card_dashboard.php");
                                    } 
