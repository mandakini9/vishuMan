                ...
                <div class="row justify-content-center">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if (empty($message)) {
                            ...
                            $db = dbConn();
                            $sql = "INSERT INTO `users`(`UserName`, `Password`,`UserType`) VALUES ('$user_name','$pw','teacher')";
                            $db->query($sql);
                            ...
                            foreach ($_POST['grades'] as $grade) {
                                $sql = "INSERT INTO `teachers_grades`(`TeacherId`,`GradeId`,`SubjectId`) VALUES ('$teacher_id','$grade','$subject')";
                                $db->query($sql);
                            }      
                    ...
                    ?>
                        ...
                        <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" role="form" class="php-email-form" novalidate>
                            <div class="row gy-4">
                                ...
                                <div class="col-md-2">
                                    <label for="district">Title</label>
                            ...
                            <div class="text-danger mt-4"><?= @$message['gender'] ?></div>
                             ...
                             <input class="form-check-input" type="checkbox" id="grade" nam" value="grade_6" >
                                        <label class="form-check-label" for="grade_6">6</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="grade" name="grades[]" value="grade_7">
                                        <label class="form-check-label" for="grade_7">7</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="grade" name="grades[]" value="grade_8">
                                        <label class="form-check-label" for="grade_8">8</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="grade" name="grades[]" value="grade_9">
                                        <label class="form-check-label" for="grade_9">9</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="grade" name="grades[]" value="grade_10">
                                        <label class="form-check-label" for="grade_10">10</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="grade" name="grades[]" value="grade_11">
                                        <label class="form-check-label" for="grade_11">11</label>
                                    </div>
                                 </div>
